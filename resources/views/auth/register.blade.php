...
<body>
    <section class="vh-100 " style="background-image:royalblue">
                    ...
                    <div class="col-12 col-md-9 col-lg-7 col-xl-6 ">
                        <div class="card shadow   " style="background-color:white; border-radius: 15px;">
                            <div class="card-body p-5">
                                <div class="p-4">
                                    <h3 class="my-4 d-flex justify-content-center text-primary">Sign Up</h3>
                                    ...
                                    <form method="post" action="{{ route('register.perform') }}">
                                        ...
                                        <div class="wrapper mb-3">
                                            <input type="text" required="required" name="username"
                                                value="{{ old('username') }}" aria-describedby="username">
                                        ...
                                        <p class="text-center text-muted mt-2 mb-0">Have already an account? <a
                                                ...
                                                class="fw-bold  text-success"><u>Login
                                                    here</u></a></p>
                                    </form>
