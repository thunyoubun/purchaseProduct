...
<div class=" vh-100 bg-light  " style="width:100%">
    @auth
    <div class="">
        <div class="container">
            <!--Corussal-->
                ...
                <div class="carousel-inner  d-flex">
                    ...
                    <div class="carousel-item active d-flex justify-content-center text-center bg-white  ">
                        <a href="" class=" text-decoration-none text-dark d-block " alt="">
                            ...
                            <p class="text-wrap font-weight-bold" style="width:200px ;">สาบานรักราชันจอมเวท - Ousama no
                                Propose</p>
                        </a>
                        ...
                        <a href="" class="items text-decoration-none text-dark d-block " alt="">
                            <img src="assets/hits/_LN_Shijo_Saikyou_KV_1_.jpg" class="items border rounded-circle m-3">
                            <p class="text-wrap font-weight-bold" style="width:200px ;">
                    ...
                    <div class="carousel-item active d-flex justify-content-center text-center bg-white gap-3">
                        ...
                        <a href="" class="items text-decoration-none text-dark d-block " alt="">
                            ...
                            <p class="text-wrap font-weight-bold" style="width:200px ;">ห้องเรียนจารชน - Spy Classroom
                            </p>
                        </a>
                        <a href="" class="items text-decoration-none text-dark d-block " alt="">
