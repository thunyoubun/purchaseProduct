        ...
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ url('update-account',$users->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group mb-3">
                            <label for="">Tel.</label>
                            <input type="string" name="phone" value="{{$users->phone}}" class="form-control">
                        </div>
                        <div class="form-group mb-3">
                            <label for="">Address</label>
                            <input type="string" name="address" value="{{$users->address}}" class="form-control">
                        </div>
                        <div class="form-group mb-3">
