...
<header class="p-3 text-white " style="background-color:royalblue">
    <div class="container">
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-center">
            <div class="col">
                <a href="/"
                    class="d-flex align-items-center mb-2 mb-lg-0 justify-content-start text-white  text-decoration-none  ">
                    <h3>Product</h3>
                </a>
            </div>
            <!--Serch -->
            <div class="box col  " style="width: 450px;">
                <div class="search-box ">
                    <input style="background-color:white" type="search" placeholder="Search">
            ...
            <!-- <div class="col col-lg-3 mb-3 mb-lg-0 me-lg-3 navbar ">
